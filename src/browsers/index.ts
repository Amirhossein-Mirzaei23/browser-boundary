export type { BrowserBinary, BrowserInstallOptions, BrowserProvider, BrowserVersion, ControllerKind } from './types.js';
...
export { resolveLegacyChromeDriver, LEGACY_CHROMEDRIVER_MATRIX, type LegacyChromeDriverCompat } from './chromedriver-matrix.js';
